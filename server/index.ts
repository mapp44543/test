...
// Load .env from multiple locations with priority
...
const dotenvPath = (function () {
  ...
  // return project path as default
    ...
    server.close(async () => {
      ...
      try {
        ...
        if (process.env.DATABASE_URL) {
          ...
          // Database is managed by drizzle-orm and connection pooling
          // Graceful closure handled by pg pool
        }
      } catch (error) {
